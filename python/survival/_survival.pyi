...
class CoxPHFit:
    ...
    def coefficients(self) -> list[float]: ...
    @property
    def concordance(self) -> ConcordanceFit: ...
    @property
...
class CoxpenalFit:
    ...
    def coefficients(self) -> list[float]: ...
    @property
    def coxlist1(self) -> CoxPenaltyTerms | None: ...
    @property
    def coxlist2(self) -> CoxPenaltyTerms | None: ...
    @property
    def coxph(self) -> CoxPHFit: ...
    @property
...
class LinkFunctionParams:
    ...
    def bcloglog_inverse(self, eta: float) -> float: ...
    def bcloglog_inverse_many(self, input: Sequence[float | None]) -> list[float]: ...
    def bcloglog_many(self, input: Sequence[float | None]) -> list[float]: ...
    def blog(self, input: float) -> float: ...
    def blog_inverse(self, eta: float) -> float: ...
    def blog_inverse_many(self, input: Sequence[float | None]) -> list[float]: ...
    def blog_many(self, input: Sequence[float | None]) -> list[float]: ...
    def blogit(self, input: float) -> float: ...
    def blogit_inverse(self, eta: float) -> float: ...
    def blogit_inverse_many(self, input: Sequence[float | None]) -> list[float]: ...
    def blogit_many(self, input: Sequence[float | None]) -> list[float]: ...
    def bprobit(self, input: float) -> float: ...
    def bprobit_inverse(self, eta: float) -> float: ...
    def bprobit_inverse_many(self, input: Sequence[float | None]) -> list[float]: ...
...
def survexp_cox(
    curves: Sequence[CoxSurvfitCurve],
    group: Sequence[int],
    weights: Sequence[float],
    y: Sequence[float] | None = None,
    times: Sequence[float] | None = None,
