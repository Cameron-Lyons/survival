...
class RateTable:
    ...
    def dimension_specs(self) -> list[RateDimension]: ...
    def lookup(self, coords: dict[str, float]) -> float: ...
    def lookup_many(self, coords: dict[str, list[float]]) -> list[float]: ...
...
class CchFitResult:
    ...
    @property
    def coefficient_aliases(self) -> list[bool]: ...
    @property
    def information_matrix(self) -> list[list[float]]: ...
    @property
    def naive_information_matrix(self) -> list[list[float]]: ...
    @property
    def model_information_matrix(self) -> list[list[float]]: ...
    @property
    def phase2_variance(self) -> list[list[float]]: ...
    @property
    ...
    @property
    def subcohort_sizes(self) -> list[int]: ...
    @property
    def optimization_fraction(self) -> list[list[float]] | None: ...
    @property
    def phase2_score_matrix(self) -> list[list[float]] | None: ...
    @property
    def collapsed_score_rows(self) -> list[list[float]] | None: ...
...
class CoxPHFrailtyFit:
    @property
    def coefficients(self) -> list[list[float]]: ...
    @property
    def frailty(self) -> list[float]: ...
    @property
    def means(self) -> list[float]: ...
    @property
    def score_vector(self) -> list[float]: ...
    ...
    def naive_information_matrix(self) -> list[list[float]]: ...
    @property
    def frailty_variance(self) -> list[float]: ...
    @property
    def covariate_degrees_of_freedom(self) -> list[float]: ...
    @property
    def frailty_degrees_of_freedom(self) -> float: ...
    @property
    def degrees_of_freedom(self) -> float: ...
    @property
    def log_likelihood(self) -> list[float]: ...
    @property
    def penalized_log_likelihood(self) -> float: ...
    @property
    def score_test(self) -> float: ...
    @property
    def convergence_flag(self) -> int: ...
    ...
    @property
    def penalty_matrix(self) -> list[list[float]]: ...
    @property
    def dense(self) -> bool: ...
    @property
    def frailty_columns(self) -> list[int]: ...
    @property
    def event_times(self) -> list[float]: ...
    @property
    def status(self) -> list[int]: ...
    ...
    def expected_basehaz_with_strata(
        self,
    ) -> tuple[list[float], list[float], list[int]]: ...
    def martingale_residuals(self) -> list[float]: ...
    def deviance_residuals(self) -> list[float]: ...
...
class MultiStateCoxHazards:
    @property
    def increments(self) -> list[list[list[float]]]: ...
...
class CoxphDetail:
    ...
    def strata_at_times(self) -> list[int]: ...
...
class PWPResult:
    ...
    def baseline_times(self) -> list[float]: ...
    @property
    def baseline_strata(self) -> list[int]: ...
...
class CoxPHModel:
    ...
    def deviance_residuals(self) -> list[float]: ...
    def dfbeta(self) -> list[list[float]]: ...
    def brier_score(self, time: float | None = None) -> float: ...
...
class GroupedSurvFitKMOutput:
    @property
    def groups(self) -> list[int]: ...
    @property
    def time(self) -> list[list[float]]: ...
    @property
    def n_risk(self) -> list[list[float]]: ...
    @property
    def n_risk_count(self) -> list[list[float]]: ...
    @property
    def n_event(self) -> list[list[float]]: ...
    @property
    def n_event_count(self) -> list[list[float]]: ...
    @property
    def n_censor(self) -> list[list[float]]: ...
    @property
    def n_censor_count(self) -> list[list[float]]: ...
    @property
    ...
    def cumhaz(self) -> list[list[float]]: ...
    @property
    def std_chaz(self) -> list[list[float]]: ...
    @property
    def conf_lower(self) -> list[list[float]]: ...
    @property
    def conf_upper(self) -> list[list[float]]: ...
...
class SurvFitAJ:
    ...
    @property
    def influence_chaz(self) -> list[list[float]] | None: ...
    @property
    def influence_auc(self) -> list[list[float]] | None: ...
    @property
...
class SurvCheckResult:
    ...
    @property
    def overlap_rows(self) -> list[int]: ...
    @property
    def gap_ids(self) -> list[int]: ...
    @property
    def gap_rows(self) -> list[int]: ...
    @property
    def jump_ids(self) -> list[int]: ...
    @property
    def jump_rows(self) -> list[int]: ...
    @property
    def teleport_ids(self) -> list[int]: ...
    @property
    def teleport_rows(self) -> list[int]: ...
    @property
...
class LogRankResult:
    def __init__(
        ...
        variance: float,
        weight_type: str,
        variance_diagonal: list[float] | None = None,
    ) -> None: ...
    @property
    def statistic(self) -> float: ...
    @property
    ...
    def variance(self) -> float: ...
    @property
    def variance_diagonal(self) -> list[float]: ...
    @property
...
def timefix_vectors(vectors: list[list[float]], tolerance: float) -> list[list[float]]: ...
def neardate(
    id1: list[int],
    date1: list[float],
    id2: list[int],
...
def cipoisson_many(
    k: list[float | None], time: list[float | None], p: list[float | None], method: str
...
def coxph_frailty_fit(
    ...
    initial_frailty: list[float] | None = None,
    max_iter: int | None = None,
    eps: float | None = None,
    ...
    tdf: float | None = None,
    dense: bool = False,
    frailty_columns: list[int] | None = None,
) -> CoxPHFrailtyFit: ...
def cox_multistate_stack(
    start: list[float] | None,
    stop: list[float],
    event: list[int],
...
def cox_multistate_hazards(
    ...
    ph_scales: list[float],
    profile_linear_predictors: list[list[float]],
    times: list[float],
    user_stratum: int,
