...
pub use survfitkm_module::{
    ...
    SurvFitKMOutput, SurvfitCurveResult, SurvfitKMOptions,
    compute_robust_survfitkm_with_timefix, compute_survfitkm, counting_survfit_tables,
    robust_counting_survfit_variance, robust_survfitkm, survfit_curve_from_tables, survfitkm,
